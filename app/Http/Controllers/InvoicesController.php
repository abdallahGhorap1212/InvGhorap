...
use App\Notifications\AddInvoicesComplete;
...
class InvoicesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Notification::send($user1, new AddInvoicesComplete($invoices));
    ...
    //     return view('invoices.invoices_paid', compact('name'));
    // }
