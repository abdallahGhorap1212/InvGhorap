...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">الرئيسية</h2>
            </div>
        </div>
...
@section('js')
    ...
    <script src="{{ URL::asset('https://cdn.jsdelivr.net/npm/apexcharts') }}"></script>
    <script src="{{ URL::asset('https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.5.0/Chart.min.js') }}"></script>
    {!! $chartjs->renderChartJsLibrary() !!}
    {!! $chartjs->renderJs() !!}
    {!! $chartjs_2->renderJs() !!}
@endsection
